...
export default function ImagesTemplate({
  ...
  return (
    <div className="relative w-full h-[500px]">
      ...
      {/* Text Content */}
      <div className="w-full container absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bottom-14 md:bottom-16 lg:bottom-8 text-white z-10  px-4 py-8 md:py-16 lg:py-20">
