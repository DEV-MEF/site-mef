...
export default function AllNews() {
    ...
    const applySearch = () => {
        ...
        router.push(`/noticias?${newParams.toString()}`, { scroll: false });
    };
        ...
        <section className="w-full flex flex-col">
            ...
            <div className="w-full py-3 mb-14">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4 lg:gap-8 2xl:gap-4">
                    {news.map((item) => (
                        <div key={item.documentId} className="bg-white shadow-[0_-10px_39px_0_rgba(8,18,109,.1)] rounded overflow-hidden">
                            ...
                            <div className="px-4 md:px-6 lg:px-7 py-4 flex flex-col gap-2">
                                ...
                                <p className="text-text-light text-xs font-normal mb-4">{item.summary?.slice(0, 98)}</p>
                                <button
