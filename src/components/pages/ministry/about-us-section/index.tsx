  ...
  return (
    <section className="w-full flex flex-col gap-8">
      ...
      <h2 className="text-md font-semibold text-light mb-6">
        Minisstério da Economia e Finanças
      </h2>
      <p className="font-light text-justify leading-loose mb-8 text-sm">
        O <strong>Ministeério da Economia e Finanças (MEF)</strong> é o organismo
      ...
      <p className="font-light text-justify leading-loose text-sm">
        É transferida para o Ministsério da Economia e Finanças, proveniente do
