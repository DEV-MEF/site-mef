...
export default function AboutUs() {
    return (
        ...
        <div>
            ...
            <h3 className="text-md font-semibold text-light my-6">Competência o Ministro</h3>
            <p className="font-light text-justify leading-loose mb-8 text-sm">
            ...
            <h3 className="text-md font-semibold text-light my-6">Integração de novo serviço</h3>
