                ...
                <div className="col-span-1 flex flex-col space-y-8">
                    ...
                    <div className="bg-[#F1F1FF] p-6 rounded-lg">
                        ...
                        <ul className="font-light text-sm space-y-4">
                            ...
                            <a href="#">
                                <li className="flex justify-between py-2 efects hover:pl-5">
                    ...
                    <div className="bg-[#F1F1FF] p-6 rounded-lg">
                        ...
                        <div className="flex flex-wrap gap-2">
                            <span
                                className="bg-[#5151F8] text-white px-3 py-1 rounded-full text-[12px] cursor-pointer">TAG1</span>
                            <span className="bg-[#5151F8] text-white px-3 py-1 rounded-full text-[12px] cursor-pointer">Tag 2</span>
                            <span
                                className="bg-[#5151F8] text-white px-3 py-1 rounded-full text-[12px] cursor-pointer">TAG3</span>
                            <span
                                className="bg-[#5151F8] text-white px-3 py-1 rounded-full text-[12px] cursor-pointer">TAG4</span>
                            <span
                                className="bg-[#5151F8] text-white px-3 py-1 rounded-full text-[12px] cursor-pointer">TAG5</span>
                        </div>
                    </div>
                </div>
            </div>
